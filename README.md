...
- Persistent SSH connection — one long-lived tunnel for high-frequency agent interactions, no repeated logins
- All SSH and SKILL commands are logged for traceability for agent-driven workflows
